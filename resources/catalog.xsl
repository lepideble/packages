  ...
  <xsl:template match="/catalog:catalog">
    <html>
      <head>
        ...
        <link rel="stylesheet" href="https://lepideble.github.io/packages/resources/catalog.css" type="text/css" />
        <script src="https://lepideble.github.io/packages/resources/list.min.js"></script>
        <script>
