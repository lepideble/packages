  ...
  <xsl:template match="/catalog:catalog">
    <html>
      <head>
        ...
        <link rel="stylesheet" href="https://packages.lepideble.github.io/resources/catalog.css" type="text/css" />
        <script src="https://packages.lepideble.github.io/resources/list.min.js"></script>
        <script>
